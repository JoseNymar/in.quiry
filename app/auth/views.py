...
def register():
    ...
    if form.validate_on_submit():
        ...
        student = Student(admission=admission, home_number=home_number, cell_number=cell_number, email=email, 
                            password=password)
...
def login():
    ...
    if form.validate_on_submit():
        ...
        student = Student.query.filter_by(admission=form.admission.data).first()
